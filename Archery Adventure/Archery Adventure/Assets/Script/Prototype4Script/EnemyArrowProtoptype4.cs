...
public class EnemyArrowProtoptype4 : MonoBehaviour {
    ...
    protected void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.gameObject.tag == "Player")
        {
            ...
            {             
                ...
                GameControllerPrototype4.Instance.SetGameLose();
                hit = true;
            }
        }
    }
    ...
    void InitArrow()
    {
        ...
        SetTrajectory(GetComponent<Rigidbody2D>(), PlayerControllerProtoptype4.Instance.gameObject.transform.position, 10);
    }
}
